            ...
            <div class='container-fluid'>
                ...
                <div class='collapse navbar-collapse' id='navbarTogglerDemo01'>
                    ...
                    <ul class='navbar-nav me-auto mb-2 mb-lg-0'>
                        <li class='nav-item'>
                            <a class='nav-link active' aria-current='page' href='../index.php'><h4 class='link'>Home</h4></a>
                        </li>";
                        ...
                        <li class='nav-item'>
                            <a class='nav-link' aria-current='page' href='../product/create.php'><h4 class='link'>Create</h4></a>
                        </li>";
                        }
